                    ...
                    <div class="row">
                        ...
                        <div class="feature-block col-lg-4 col-md-6 col-sm-12">
                            <div class="inner-box">
                                ...
                                <h3><a href="{{ route('frontend.categories.posts') }}">Perfect Design</a></h3>
                                <div class="text">A wonderful serenity has taken possession of my entire soul, like these
                        ...
                        <div class="feature-block col-lg-4 col-md-6 col-sm-12">
                            <div class="inner-box">
                                ...
                                <h3><a href="{{ route('frontend.categories.posts') }}">Carefully Planned</a></h3>
                                <div class="text">A wonderful serenity has taken possession of my entire soul, like these
                                    sweet mornings of spring which I enjoy with my whole heart.</div>
                                <div class="link-box"><a href="{{ route('frontend.categories.posts') }}">Read More</a></div>
                            </div>
                        ...
                        <div class="feature-block col-lg-4 col-md-6 col-sm-12">
                            <div class="inner-box">
                                ...
                                <h3><a href="{{ route('frontend.categories.posts') }}">Smartly Execute</a></h3>
                                <div class="text">A wonderful serenity has taken possession of my entire soul, like these
                                    sweet mornings of spring which I enjoy with my whole heart.</div>
        ...
        <div class="auto-container">
            ...
            <div class="testimonial-carousel-two owl-carousel owl-theme">
                ...
                <div class="testimonial-block-two">
                    <div class="inner-box">
                        <div class="text">I got an excellent design for my future home, from cooperation i was very
                            pleased, everything was done at the highest level.Boldly I recommend to all this company.</div>
                        <div class="info-box">
            ...
            <div class="row">
                ...
                <div class="process-block col-lg-3 col-md-6 col-sm-12">
                    <div class="inner-box">
                        ...
                        <h4><a href="{{ route('frontend.categories.posts') }}">Concept</a></h4>
                        <div class="text">When an unknown printer took a galley of type and scrambled it to make a book.
                        </div>
                        <div class="link-box"><a href="{{ route('frontend.categories.posts') }}">Read More</a></div>
                    </div>
                </div>
                ...
                <div class="process-block col-lg-3 col-md-6 col-sm-12">
                    <div class="inner-box">
                        ...
                        <h4><a href="{{ route('frontend.categories.posts') }}">Idea</a></h4>
                        <div class="text">When an unknown printer took a galley of type and scrambled it to make a book.
                        </div>
                        <div class="link-box"><a href="{{ route('frontend.categories.posts') }}">Read More</a></div>
                    </div>
                ...
                <div class="process-block col-lg-3 col-md-6 col-sm-12">
                    <div class="inner-box">
                        ...
                        <h4><a href="{{ route('frontend.categories.posts') }}">Design</a></h4>
                        <div class="text">When an unknown printer took a galley of type and scrambled it to make a book.
                        </div>
                        <div class="link-box"><a href="{{ route('frontend.categories.posts') }}">Read More</a></div>
                    </div>
                ...
                <div class="process-block col-lg-3 col-md-6 col-sm-12">
                    <div class="inner-box">
                        ...
                        <h4><a href="{{ route('frontend.categories.posts') }}">excecution</a></h4>
                        <div class="text">When an unknown printer took a galley of type and scrambled it to make a book.
                        </div>
                        <div class="link-box"><a href="{{ route('frontend.categories.posts') }}">Read More</a></div>
                    </div>
                    ...
                    <div class="content-column col-lg-6 col-md-12 col-sm-12">
                        <div class="inner-column">
                            ...
                            <div class="text">Present all the speakers and participants in GenesisExpo`s beautiful
                                layouts. Choose your favorite variant of layout and create your own. You can create also
                                single speaker profile with all relevant information.</div>
                        </div>
                    </div>
